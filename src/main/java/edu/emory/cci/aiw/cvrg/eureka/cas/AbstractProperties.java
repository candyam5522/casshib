...
public abstract class AbstractProperties {
	...
	private final File casProperties;
	...
	public AbstractProperties() {
		...
		loadFallbackConfig();
		loadDefaultConfig();
		this.casProperties = new File(this.configDir, "cas.properties");
	}
	...
	public String getCasPropertiesPathname() {
		return this.casProperties.exists() ? "file:" + this.casProperties.getPath() : "classpath:/cas.properties";
	}
